  ...
  return (
    <div className="modal-backdrop" role="dialog" aria-modal="true" aria-label="Rules">
      <div className="modal">
        ...
        <p>The ball enters an obstacle square, hits the obstacle, and turns. Rails and solid blocks bounce it back. Cracked pieces work once during a shot, then reset on the next attempt.</p>
